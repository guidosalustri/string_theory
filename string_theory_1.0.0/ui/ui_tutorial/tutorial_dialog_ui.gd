...
@onready var rich_text_label: RichTextLabel = $CenterContainer/PanelContainer/RichTextLabel
...
func play_dialog() -> void:
	...
	_tween = create_tween()
	_tween.tween_property(rich_text_label, "visible_ratio", 1.0, rich_text_label.text.length() / TEXT_DISPLAY_SPEED)
